...
class UnsafeExpressionError(ValueError):
    ...
    Inherits from ValueError so callers may catch either the specific
    subclass or the broader ``ValueError`` — useful when sharing code
    paths that also raise plain ValueError (e.g. numeric coercion).
    """
