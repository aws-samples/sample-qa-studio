    ...
    it('makes successful API call with correct parameters', async () => {
      const mockResponse = {
        ...
        usecaseData: JSON.stringify({
          exportVersion: '1.0',
          usecase: { name: 'Test', description: 'Test case', starting_url: 'https://example.com', active: true,  region: 'us-east-1', tags: [] },
          steps: [],
          variables: [],
          secrets: [],
          hooks: null
  ...
  describe('Performance', () => {
    ...
    it('handles large response payloads efficiently', async () => {
      ...
      const largeUsecaseData = {
        exportVersion: '1.0',
        usecase: { name: 'Large Test', description: 'Test', starting_url: 'https://example.com', active: true,  region: 'us-east-1', tags: [] },
