...
Artifacts stored in: `./artifacts/<execution-id>/`
...
2. `./artifacts/<id>/recording.webm` for visual debugging
3. `./artifacts/<id>/execution.log` for detailed logs
...
2. Review video: `./artifacts/<id>/recording.webm`
