...
✓ Skills installed (3 skills in ~/.kiro/skills/)
```
...
qa-studio setup      # Install Kiro skills
```
...
# 3. Review artifacts (video, logs) in ./artifacts/<execution-id>/
```
...
```
**Fix:** 
1. Review video in `./artifacts/<execution-id>/recording.webm`
